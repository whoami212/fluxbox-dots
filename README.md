...
### bemenu
Copy [bemenu-run](https://github.com/whoami212/fluxbox-dots/blob/37b0fb1d32faab990525127c40c5f0ebe92695bd/bemenu-run) to ~/.local/bin/ and set it to whatever keybind you prefer in ~/.fluxbox/keys.
